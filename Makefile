...
ARC = ar rc
SRC = ft_sorter.c ft_array_swap.c ft_content_display.c ft_dir_count.c ft_dir_copy.c
OBJ = ft_sorter.o ft_array_swap.o ft_content_display.o ft_dir_count.o ft_dir_copy.o
